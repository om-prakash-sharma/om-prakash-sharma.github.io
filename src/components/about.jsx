                                    ...
                                    <div className="col-md-12">
                                        <div className="about-desc">
                                            ...
                                            <p>
                                                ...
                                                Engineering) from GIT Jaipur in
                                                2015. I love exploring new
                                                technologies and always try to
                                                implementing new
                                                things/technology in my
                                                projects.
                                            </p>
                                            <p>
                                                Currently working as a Full
                                                Stack Developer with experience
                                                in building websites, web
                                                applications and mobile
                                                applications. Ability to learn
                                            ...
                                            <p>
                                                ...
                                                >
                                                    Check CV{" "}
                                                    <i className="icon-download4 download-cv" />
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="col-md-4 text-center animate-box">
                                <div className="services color-4">
                                    ...
                                    <div className="desc">
                                        ...
                                        <p>
                                            Experience in building Native
                                            Android apps using java, xml and
                                            Hybrid apps using Ionic framework
                                            (JavaScript){" "}
                                        </p>
                                    </div>
                                </div>
